...
const NewPost: React.FunctionComponent<{ [label: string]: any }> = (props: any) => {
    ...
    const customCategoryInput = (<View style={{ backgroundColor: '#f2f2f7',  marginVertical: 20, paddingHorizontal: 20 }}>
        ...
        <View style={{ flexDirection: 'column', backgroundColor: '#f2f2f7' }}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', backgroundColor: '#f2f2f7', alignItems: 'center', marginTop: 10, }}>
    ...
    return <Popup isOpen={props.show} 
        ...
        responsive={{
            ...
            <View style={{ flexDirection: 'column', paddingHorizontal: 20, marginVertical: 20, minWidth: Dimensions.get('window').width > 768 ? 400 : 200, maxWidth: Dimensions.get('window').width > 768 ? 400 : 300, backgroundColor: '#f2f2f7' }}>
                <Text style={{
                    fontSize: 13,
                    textTransform: 'uppercase',
                    fontFamily: 'inter'
            ...
            {customCategoryInput}
            {props.isOwner ? null : <View style={{ flexDirection: 'column', paddingHorizontal: 20, marginVertical: 20, minWidth: Dimensions.get('window').width > 768 ? 400 : 200, maxWidth: Dimensions.get('window').width > 768 ? 400 : 300, backgroundColor: '#f2f2f7' }}>
                <Text style={{
                    fontSize: 11,
                    textTransform: 'uppercase',
                    fontFamily: 'overpass'
