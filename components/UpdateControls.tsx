...
const UpdateControls: React.FunctionComponent<{ [label: string]: any }> = (props: any) => {
    ...
    const renderEquationEditor = () => {
        return showEquationEditor ? (
            <View
                ...
                >
                    <Ionicons name="help-circle-outline" color="#1A2036" size={17} />
                </TouchableOpacity>
            </View>
        ) : null;
    };
            ...
            <View style={{ flexDirection: 'row', width: '100%' }}>
                ...
                {/* {(props.folderId !== "" || isOwner) && !props.showComments ? <View style={{}}>
                    <TouchableOpacity
                        ...
                        <Text>
                            <Ionicons name={props.showFolder ? 'backspace-outline' : 'folder-open-outline'} size={17} color={props.showFolder ? '#50566B' : '#5469D4'} />
                        </Text>
                    </TouchableOpacity>
                </View> : null} */}
                ...
                {isQuiz ? (
                    ...
                    <View
                        ...
                        {/* <a download={true} href={url} style={{ textDecoration: "none", textAlign: "center" }}>
                            <View>
                                <Ionicons name="cloud-download-outline" color="#50566B" size={15} />
                                <Text
                                    style={{
                                        fontSize: 10,
                                        color: "#50566B",
    ...
    const renderQuizEndedMessage = () => {
        return (<View style={{ backgroundColor: 'white', flex: 1, }}>
            <Text style={{ width: '100%', color: '#50566B', fontSize: 20, paddingTop: 200, paddingBottom: 100, paddingHorizontal: 5, fontFamily: 'inter', flex: 1, textAlign: 'center' }}>
    ...
    const renderQuizDetails = () => {
        ...
        return (<View style={{ display: 'flex', flexDirection: 'row', marginTop: 20, marginBottom: 10 }}>
            ...
            {duration === 0 ?
                <Text style={{ marginRight: 30 }}>No Time Limit</Text> :
                <Text style={{ marginRight: 30 }}>
                    {hours} H {minutes} min
                </Text>}
            ...
            {!isOwner ? <Text style={{ marginRight: 30 }}>
            ...
            >
                <TouchableOpacity
                    ...
                    <Text
                        ...
                        {/* <Ionicons name={updatingCueContent ? 'ellipsis-horizontal-outline' : 'cloud-upload-outline'} size={17} color={'#5469D4'} /> */}
                    </Text>
                </TouchableOpacity>
            </View > : null
    }
                    ...
                    <View style={{ flexDirection: "row", justifyContent: width < 1024 ? 'flex-start' : 'flex-end' }}>
                        {isOwner ? (
                            ...
                            <View style={{ flex: 1, backgroundColor: "#fff" }}>
                                <Text style={{ fontSize: 11, color: '#1A2036', textTransform: 'uppercase' }}>{!submission ? PreferredLanguageText("no") : null}</Text>
                            </View>
                        )}
                    </View>
                    {submission ? (
                            ...
                            <View style={{ backgroundColor: "white", paddingRight: 20, paddingLeft: 20 }}>
                                <TouchableOpacity
                                    ...
                                    <Text
                                        ...
                                        <Ionicons name={addCustomCategory ? "close" : "add"} size={15} color={"#1A2036"} />
                                    </Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    ...
                    <View
                        ...
                        {/* <TouchableOpacity
                            ...
                            <Text
                                ...
                                <Ionicons name="bookmark" size={40} color={starred ? "#f94144" : "#50566B"} />
                            </Text>
                        </TouchableOpacity> */}
                    </View>
                ) : (
