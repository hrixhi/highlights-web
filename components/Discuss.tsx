        ...
        return (
            <div className="flex flex-1 xl:overflow-hidden min-h-coursework">
                ...
                <div
                    ...
                    className="md:w-80 xl:w-96 flex-shrink-0 border-l border-cues-border dark:border-cues-border-dar bg-white dark:bg-cues-dark-3 xl:flex xl:flex-col px-6"
                >
    ...
    const renderThreadsLarge = () => {
        return (
            <div className="flex flex-1 xl:overflow-hidden min-h-coursework">
                ...
                <div
                    aria-label="Threads Section"
                    className="md:w-80 xl:w-96 flex-shrink-0 border-r border-cues-border dark:border-cues-border-dark border-blue-gray-200 bg-white dark:bg-cues-dark-3 xl:flex xl:flex-col px-6"
                >
